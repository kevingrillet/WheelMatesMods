...
to each local vehicle's yaw. It shares a vertical HUD container with POCCoordinates.
...
The user confirmed POCCompass working again after the loaded-target filter correction
