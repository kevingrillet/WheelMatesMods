...
updated every 150 ms. POCCoordinates and POCCompass share a vertical HUD container and
...
helpers remain in the disabled-by-default `POCCoordinatesDiagnostics` module.
