...
active-save selection, Compass scan frequency and WallHack state restoration.
...
Compass tests cover UP/DOWN per player, both LEVEL tolerance boundaries and 3D distance.
